...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.31.0.28/23 | 172.31.0.5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_leaf-1a_Ethernet2 | *trunk | *20-23,250 | *- | *- | 1 |
| Ethernet2 | L2_leaf-1b_Ethernet2 | *trunk | *20-23,250 | *- | *- | 1 |
| Ethernet3 | L2_leaf-2a_Ethernet2 | *trunk | *20-23,250 | *- | *- | 3 |
| Ethernet4 | L2_leaf-2b_Ethernet2 | *trunk | *20-23,250 | *- | *- | 3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_DC1-LEAF1_Port-Channel1 | trunk | 20-23,250 | - | - | - | - | 1 | - |
| Port-Channel3 | L2_DC1-LEAF2_Port-Channel1 | trunk | 20-23,250 | - | - | - | - | 3 | - |
...
interface Port-Channel1
   ...
   no shutdown
   switchport trunk allowed vlan 20-23,250
...
| Vlan250 | default | 10.60.78.3/24 | - | 10.60.78.1 | - | - |
...
interface Vlan250
   ...
   no shutdown
   ip address 10.60.78.3/24
   ip virtual-router address 10.60.78.1
!
interface Vlan4093
   description MLAG_L3
   no shutdown
