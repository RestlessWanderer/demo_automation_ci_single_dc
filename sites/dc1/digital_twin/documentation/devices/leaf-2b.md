...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.31.0.50/23 | - |
...
| --------- | --------------- | ------------ | --------- |
| DC1-LEAF2 | Vlan4094 | 10.253.1.0 | Port-Channel47 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_spine-1_Ethernet4 | *trunk | *110,120,130 | *- | *- | 1 |
| Ethernet2 | L2_spine-2_Ethernet4 | *trunk | *110,120,130 | *- | *- | 1 |
...
interface Ethernet47
   description MLAG_leaf-2a_Ethernet47
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description MLAG_leaf-2a_Ethernet48
   no shutdown
   channel-group 47 mode active
```
...
interface Port-Channel47
   description MLAG_leaf-2a_Port-Channel47
   no shutdown
   switchport mode trunk
